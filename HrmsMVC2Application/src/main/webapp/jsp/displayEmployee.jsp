		...
		<div class="form-row">
		  ...
		  <div class="form-row">
		    ...
		    <div class="form-group col-md-4">
		      ...
		      <input type="text" class="form-control" id="department" required name="department" value=<%=emp.getDepartment() %>>
		    </div>
		     ...
		     <div class="form-row">
		      ...
		      <input type="text" class="form-control" id="netSalary" required name="netSalary" required value=<%=emp.getPayrollInfo().getSalary_net() %>>
		    </div>
		    <div class="form-group col-md-3">
		      <label for="salarybasic">Salary Basic</label>
		      <input type="text" class="form-control" id="salarybasic" name="salarybasic" value=<%=emp.getPayrollInfo().getSalary_basic() %>>		      
		    </div>
		    <div class="form-group col-md-2">
		       <label for="salaryhra">Salary HRA</label>
		      <input type="text" class="form-control" id="salaryhra" name="salaryhra" value=<%=emp.getPayrollInfo().getSalary_hra() %>>		 
		    </div>
		    <div class="form-group col-md-2">
		       <label for="salaryta">Salary TA</label>
		      <input type="text" class="form-control" id="salaryta" name="salaryta" value=<%=emp.getPayrollInfo().getSalary_ta() %>>	
		    </div>
		    <div class="form-group col-md-2">
		       <label for="salaryda">Salary DA</label>
		      <input type="text" class="form-control" id="salaryda" name="salaryda" value=<%=emp.getPayrollInfo().getSalary_ta() %>>	
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputAddress">Office Address</label>
		    <input type="text" class="form-control" id="inputAddress"  name="inputAddress" placeholder="1234 Main St" value= <%=emp.getOfficeAddress().getAddressLine1() %>>
		  </div>
		  <div class="form-group">
		    <label for="inputAddress2">Office Address 2</label>
		    <input type="text" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" value= <%=emp.getOfficeAddress().getAddressLine2() %>>
		  </div>
		  <div class="form-row">
		    <div class="form-group col-md-6">
		      <label for="officeinputCity">Office City</label>
		      <input type="text" class="form-control" id="officeinputCity" value= <%=emp.getOfficeAddress().getCity() %>>
		    </div>
		 
		    <div class="form-group col-md-2">
		      <label for="inputOfficeZip">Office Pincode</label>
		      <input type="text" class="form-control" id="inputOfficeZip" value= <%=emp.getOfficeAddress().getPinCode() %>>
		    </div>
		  </div>
